...
Nesse módulo ainda não tinhamos visto o PostgreSQL, mas ainda sim foi pedido a persistência dos dados. Para isso, fomos apresentados a utilização do file system, um módulo do própio node.js, onde aprendemos de forma síncrona e assíncrona a escrever e ler arquivos.

## Ferramentas utilizadas : 

- IDE => Visual Studio Code
- API para processamento das request => Insomnia

Foi utilizada também a dependência express onde a instalação é feita pelo comando

```npm install express``` 

e como dependência de desenvolvimento o nodemon, pelo comando
...
Você pode fazer um fork ou até um clone deste repositório.
A porta utilizada é a 3000, você encontrará um arquivo json com as requisões utilizadas e alguns exemplares. Basta importa na API da sua máquina.

É importante ter o node.js instalado!
- onde baixar: https://nodejs.org/pt-br/download
- tutorial : https://kinsta.com/pt/blog/como-instalar-o-node-js/

## Descrição e Instruções do desafio
